...
<body>
    ...
    <div class="container">
        <div class="row">
            <h1>Регистрация</h1>
            <p class="text-left text-danger" ><?= array_shift($errors); ?></p>
            <form name="Login"
                  method="POST">
                <div class="form-group">
                    <label for="inputName">Ваше имя</label>
                    <input type="text" name="inputName" class="form-control" id="name" placeholder="Введите имя" value="<?= $user['name']; ?>" required>
                </div>
                <div class="form-group">
                    <label for="inputSurname">Ваша фамилия</label>
                    <input type="text" name="inputSurname" class="form-control" id="surname" placeholder="Введите фамилию" value="<?= $user['surname']; ?>" required>
                </div>
                <div class="form-group">
                    <label for="inputEmail">Ваш e-mail</label>
                    <input type="email" name="inputEmail" class="form-control" id="email" placeholder="Введите email" value="<?= $user['email']; ?>" required>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <input type="password" name="inputPassword2" class="form-control" id="password2" placeholder="Введите пароль еще раз" value="<?= $user['password2']; ?>" required>
                </div>
                <div class="form-group">
